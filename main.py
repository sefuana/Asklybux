...
async def handle_task_fb_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # Show as monospace text - user can press and hold to copy
    await update.message.reply_text(
        f"{DIV}\n"
        "  🍪  Account Credentials\n"
        f"{DIV}\n\n"
        ...
        "   2. Log in on a real mobile device.\n"
        "   3. Send your Email or Phone Number below.\n\n"
...
def main():
    ...
    conv = ConversationHandler(
        ...
        states={
            ...
            WITHDRAW_CONFIRM: [
                # Inline keyboard handles confirmation; text fallback goes home
