...
async def handle_get_new_mail(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Send "generating" status — cannot edit ReplyKeyboard messages, so delete + resend
    ...
    # Delete the "generating..." bubble cleanly
    try:
    ...
    # Send result as a brand-new message with inline Open Inbox button
    await ctx.bot.send_message(
        uid,
